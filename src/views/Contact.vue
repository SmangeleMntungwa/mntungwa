    ...
    <div class="contact-box">
      <div class="contact-links">
        ...
        <div class="links">
          <div class="link">
            <a
              href="https://www.linkedin.com/in/abdul-atheem-mullins-4a0229222/"
              target="_blank"
              ><img
          ...
          <div class="link">
            <a href="https://github.com/Mullins69" target="_blank"
              ><img src="https://i.postimg.cc/YCV2QBJg/github.png" alt="github"
            /></a>
          </div>
          <div class="link">
            <a href="mailto:mullinswebsupp@gmail.com"
...
export default {
  ...
  methods: {
    async handleSubmit() {
      this.loading = true;
      try {
        fetch("https://mullins-marine-api.herokuapp.com/contact", {
          method: "POST",
          body: JSON.stringify({
            name: this.name,
            email: this.email,
